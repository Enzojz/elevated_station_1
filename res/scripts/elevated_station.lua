...
local function makeEntry(height, length, n)
    ...
    local profile =
        {
            gate = "station/elevated_station/entry_" .. suffix .. ".mdl",
            rep = "station/elevated_station/entry_rep_" .. suffix .. ".mdl",
            stairs = "station/elevated_station/entry_stairs_" .. suffix .. ".mdl",
        }
    ...
    gates[1] = newModel(profile.gate, coor.flipX() * coor.flipY())
...
local function makeRoof(config)
    ...
    config.frame = "station/elevated_station/frame.mdl"
    config.angle = "station/elevated_station/angle.mdl"
    config.glass = "station/elevated_station/glass.mdl"
    config.entryXtr = "station/elevated_station/entry_xtr.mdl"
    config.tube = "station/elevated_station/tube.mdl"
...
local config = {
    platformRepeat = "station/train/passenger/1990/platform_double_repeat.mdl",
    platformStart = "station/elevated_station/platform_double_start.mdl",
    platformEnd = "station/train/passenger/1990/platform_double_end.mdl",
    platformDwlink = "station/elevated_station/platform_downstairs.mdl",
    platformRoofRepeat = "station/train/passenger/1990/platform_double_roof_repeat.mdl",
    platformRoofStart = "station/train/passenger/1990/platform_double_roof_start.mdl",
